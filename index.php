        ...
        <div class="hero">
            <div class="row justify-content-md-center">
                ...
                <div class="col col-lg-5" style="margin-top: 10%;">
                    ...
                    <h2 class="text-center hero-lead">Event Resort Reservation</h2>
                    <p class="lead text-center" style="color:white;">START BY FILLING UP THE FORM</p>
                        ...
                        <div class="text-center mt-3">
                            <p style="font-size: 11px;color:white;">By clicking "Sign Up" you agree to 's <a
...
<div class="container-fluid custom-container">
    <div class="row">
        <div class="col-lg-12">
            ...
            <hr>
            <h2 class="h2 text-uppercase text-center mb-4">EVENT PACKAGE</h2>
...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            <h2 class="h2 text-uppercase text-center mb-3"> Event Supplier</h2>
            <h6 class="h6 text-uppercase text-center text-muted mb-3">Discover Best needs for 
                your event.</h6>
