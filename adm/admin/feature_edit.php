...
<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($features) {
            ...
            $features->update_feature($_GET['id']);
            redirect_to("service_list.php?id=".$_GET['id']);
            $session->message("
        ...
        <div class="row">
            ...
            <div class="col-lg-8 offset-2 pl-3 pb-3 box-shadow mt-4">
                ...
                <form method="post" action="">
                    ...
                    <h4 class="h4 mt-4 pb-2" style="border-bottom: 1px solid #dee2e6!important;">Edit Feature</h4>
