            ...
            <div class="col-lg-8 offset-2 pl-3 pb-3 box-shadow mt-4">
                ...
                <form method="post" action="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="bride" class="form-control" value="<?= $booking_detail->bride; ?>" id="brideName" placeholder="First Name">
                    </div>
                    <div class="form-group">
                        <label for="GroomsName">Last Name</label>
                        <input type="text" name="groom" class="form-control" value="<?= $booking_detail->groom; ?>" id="GroomsName" placeholder="Last Name">
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" id="inputOrganizer" name="organizer_id">
                              <option value="1">James Russel Hackett Weddings and Events</option>
                                <option value="2">Elite Concepts Flowers and Events</option>
                                <option value="3">C & C Foods Catering Services</option>\
                                <option value="3">GEvents Management Services</option>
