...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            <h4 class="h2 text-center mb-0"> Event Supplier </h4>
            <p class="text-muted text-center">Discover the best needs for your event.</p>
        </div>
               ...
               <div class="card">
                ...
                <div class="card-body">
                    <a href="wedding_details.php?id=<?= $blog_item->id; ?>" class="btn-stamp">
                        ...
                        <p class="card-text mt-0 mb-0 text-center color_gray"><?= $blog_item->wedding_type; ?> </p>
